...
3. 🛠️ Feature Engineering:
   ...
   - After separating the target 𝑠𝑡𝑎𝑡𝑒 (I tried multiple train-test splits, 2:1 train-test split gives me the best accuracy across all models), I created dummies from 17 features, resulting in 39 predictors, and eliminated 3 having a correlation of 0.80 or higher. 
